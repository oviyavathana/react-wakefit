...
<div>
   ...
   <Productlist />
   <h4 className="text-center text-space">Buying Furniture & Mattress Online, Made simple!</h4>
   <p className="text-center mb-5">Your search for great furniture, mattress  & other home products ends here!</p>
